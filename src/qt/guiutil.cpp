...
{
    // return if URI is not valid or is no Lxrcoins: URI
...
{
    // Convert Lxrcoins:// to Lxrcoins:
    //
    //    Cannot handle this later, because Lxrcoins:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("Lxrcoins://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "Lxrcoins:");
    }
...
{
    QString ret = QString("Lxrcoins:%1").arg(info.address);
    int paramCount = 0;
