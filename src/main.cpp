...
const string strMessageMagic = "Lxrcoins Signed Message:\n";//<coingo.vip>
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s LXR additional fees, %d delta bytes\n",
